...
Optional string on each stage — supplemental instructions about _how_ to approach the task. Distinct from `prompt` (what to do) and `rationale` (why it's scheduled).
